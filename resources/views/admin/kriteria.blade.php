                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="btn-group">
                            ...
                            <a href="#modalHapusMhs" data-toggle="modal" id="tombol-hapus-mhs" data-target="#modalHapusMhs" class="btn btn-danger btn-sm" title="Hapus" data-idmhs="{{$kriteria->id}}"><i class="icon-trash"></i></a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('hapus-kriteria')}}" method="POST">
                    @csrf
