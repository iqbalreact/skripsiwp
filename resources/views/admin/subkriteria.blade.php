...
@section('title')
    <title>Sub Kriteria - Admin</title>
@endsection

@section('page-title')

    <div class="page-title">
        <h4>Halaman Sub Kriteria</h4>
    </div>
...
<div class="panel panel-flat">
    ...
    <div class="panel-body">
        ...
        <button type="button" class="btn bg-teal-400 btn-labeled" data-toggle="modal" data-target="#modal_add"><b><i class="icon-user-plus"></i></b> Tambah Sub Kriteria</button>
